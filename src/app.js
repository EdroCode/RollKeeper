...
const templates = {
  ...
  `,
    ...
    turnorder: `
        <div id="turnorder" class="flex flex-col gap-1 bg-white border rounded-2xl p-2 border-black w-64 ">
            <div class="flex items-center justify-between  gap-1">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
            ...
            <div class="flex flex-col w-full h-full justify-between py-1 ">
                ...
                <div class="flex w-full m-1 pr-2">
                ...
                <button class="text-2xl cursor-pointer border rounded-xl w-full mt-2"
...
function addOrder(base) {
    const add = turnOrderTemplates["turnLabel"];
    const container = base.closest('.flex.flex-col');
    const listdiv = container.querySelector('#orderList');

    listdiv.insertAdjacentHTML('beforeend', add);
}
